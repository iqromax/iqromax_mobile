...
export default function StudentDashboardScreen({ navigation, route }) {
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View style={[styles.mainContent, { paddingHorizontal: 20, paddingTop: 10, display: activeTab === 'exercise' ? 'flex' : 'none' }]}>
