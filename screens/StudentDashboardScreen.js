    ...
    <SafeAreaView style={styles.container}>
      ...
      <View style={[styles.mainContent, { display: activeTab === 'exercise' ? 'flex' : 'none' }]}>
        ...
        <View style={{ flex: 1, display: activeTab === 'inventory' ? 'flex' : 'none', backgroundColor: '#05050C' }}>
          ...
          <View 
            style={{ 
              ...
              paddingTop: Platform.OS === 'android' ? (StatusBar.currentHeight || 24) + 6 : 20, 
              paddingBottom: 15, 
        ...
        <View style={{ flex: 1, display: activeTab === 'ranking' ? 'flex' : 'none', backgroundColor: '#05050C' }}>
          <ScrollView style={{ flexShrink: 1 }} contentContainerStyle={{ paddingHorizontal: 20, paddingTop: Platform.OS === 'android' ? (StatusBar.currentHeight || 24) + 6 : 10, paddingBottom: 100 }} showsVerticalScrollIndicator={false}>
{/* Top Header */}
  ...
  return (
    <>
      ...
      <View style={styles.podiumContainer}>
        ...
        <View style={{ flex: 1, display: activeTab === 'profile' ? 'flex' : 'none', backgroundColor: '#05050C', paddingTop: Platform.OS === 'android' ? (StatusBar.currentHeight || 24) + 6 : 40 }}>
