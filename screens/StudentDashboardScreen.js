  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View style={[styles.mainContent, { display: activeTab === 'exercise' ? 'flex' : 'none' }]}>
        ...
        <View style={{ position: 'absolute', bottom: 85, left: 0, right: 0, paddingHorizontal: 20, paddingTop: 8, paddingBottom: 6, backgroundColor: '#05050C', zIndex: 50, borderTopWidth: 1, borderTopColor: 'rgba(255, 255, 255, 0.05)' }}>
          {/* START EXERCISE BUTTON */}
          {activeExerciseType === 'battle' ? (
            <TouchableOpacity 
