...
{/* Progress Bar */}
        ...
        {/* ACCOUNT DELETED / BLOCKED MODAL */}
        <Modal transparent visible={!!deletedReason} animationType="fade">
          <View style={{ flex: 1, backgroundColor: 'rgba(5, 5, 12, 0.92)', justifyContent: 'center', alignItems: 'center', padding: 20 }}>
            <View style={{ width: '100%', maxWidth: 340, backgroundColor: '#0A0A16', borderRadius: 24, padding: 24, alignItems: 'center', borderWidth: 1, borderColor: 'rgba(239, 68, 68, 0.4)', shadowColor: '#EF4444', shadowOffset: { width: 0, height: 10 }, shadowOpacity: 0.3, shadowRadius: 20, elevation: 15 }}>
              <View style={{ width: 80, height: 80, borderRadius: 40, backgroundColor: 'rgba(239, 68, 68, 0.15)', justifyContent: 'center', alignItems: 'center', marginBottom: 20, borderWidth: 1, borderColor: 'rgba(239, 68, 68, 0.5)' }}>
                <MaterialCommunityIcons name="account-remove-outline" size={42} color="#EF4444" />
              </View>
              <Text style={{ color: '#FFFFFF', fontSize: 22, fontWeight: '800', marginBottom: 12, textAlign: 'center' }}>Hisobingiz o'chirildi</Text>
              <Text style={{ color: 'rgba(255, 255, 255, 0.7)', fontSize: 16, textAlign: 'center', marginBottom: 30, lineHeight: 24 }}>
                {deletedReason}
              </Text>
              <TouchableOpacity
              ...
              >
                <Text style={{ color: '#FFFFFF', fontSize: 16, fontWeight: '700' }}>Bosh sahifaga qaytish</Text>
              </TouchableOpacity>
            </View>
          </View>
        </Modal>
